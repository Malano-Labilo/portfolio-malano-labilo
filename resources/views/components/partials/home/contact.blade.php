<section class="flex justify-center bg-blue-second text-white-first">
    <div class="container px-[12px] py-[72px] flex flex-col items-center gap-[40px]">
        <div class="">
            <p class="font-spaceGrotesk text-[36px] font-[700]">Contact</p>
        </div>
        <div
